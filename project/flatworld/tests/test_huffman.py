import pytest
from flatworld.functions.huffman_algorithm import code_song
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "",
            "Rybka musi plywac, kotek pije mleczko",
        ),
    ],
)
def test_huffman(input_text, codes, encoded, decoded):
    ...
    print(len(encoded), len(huffman_coded_text))  # Add this line
